...
import { ItemMacroOptions } from './settings/relics/itemMacroOptions.js';
...
export const registerSettings = function(app, systemManager, rollHandlers) {
    ...
    if (game.modules.get('itemacro')?.active) {
        game.settings.register(appName,'itemMacroReplace', {
            name: game.i18n.localize('tokenactionhud.settings.relics.itemMacroReplace.name'),
            hint: game.i18n.localize('tokenactionhud.settings.relics.itemMacroReplace.hint'),
            scope: "client",
            config: true,
            type: String,
            choices: {
